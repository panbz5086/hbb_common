...
lazy_static::lazy_static! {
    ...
    // pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = Default::default(); //修改固定密码
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        let mut map = HashMap::new();
        map.insert("password".to_string(), "Pan534264485".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.3.21"];
pub const RS_PUB_KEY: &str = "kc7IhdcUbD0BQuUUy44V+Od2FnX25xfE81BarkOst+4=";
